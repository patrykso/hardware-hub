    ...
    <section class="admin-page">
      <header class="admin-topbar surface-card admin-topbar-surface">
        ...
        <label class="input-group admin-search">
          ...
          <input v-model="query" type="search" placeholder="Search for device, brand, or serial number..." />
        </label>
      ...
      <div class="admin-content">
        <div class="admin-heading-row">
          ...
          <button class="primary-button admin-add-button" type="button" @click="$router.push('/admin/equipment/new')">
...
const currentUserName = computed(() => hub.currentUser.value?.displayName || 'User');
